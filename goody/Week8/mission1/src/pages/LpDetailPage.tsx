...
const LpDetailPage = () => {
    ...
    const [isDeletLpOpen, setIsDeleteLpOpen] = useState(false);
    // 폼 입력
    ...
    return (
        <div className="mt-20 mx-auto h-screenjustify-center items-center border-gray-500 border-2 p-4 rounded-large shadow-lg bg-lime-200 w-[70%] max-h-[100vh]">
            ...
            <div className="flex flex-col gap-4">
                        ...
                        {isAuthor && (
                            <>
                                ...
                                <>
                                    ...
                                    <button onClick={() => setIsDeleteLpOpen(true)} className="cursor-pointer">🗑️</button>
                                    <Modal isOpen={isDeletLpOpen} onClose={() => setIsDeleteLpOpen(false)}>
                                        <div className="flex flex-col gap-5 p-4 justify-center items-center bg-white text-black border-2 border-fuchsia-200 rounded-xl">
                                        <h3 className="font-bold text-center text-xl">정말 삭제 하시겠습니까?</h3>
                                        <div className="flex gap-5 w-full">
                                            ...
                                            <button 
                                            onClick={() => setIsDeleteLpOpen(false)}
                                            className="flex-1 border-2 border-fuchsia-50 rounded-2xl cursor-pointer font-semibold"
                                            >
                                            아니오
                                            </button>
                ...
                <button onClick={isLiked ? handleDisLikeLp : handleLikeLp} className="flex justify-center items-center cursor-pointer">
