...
// esc로 sidebar 닫기
  ...
  return (
    <>
      <div
        className={`flex flex-col space-y-5 justify-between items-center w-[250px] bg-gray-200 transform transition-transform duration-300 ease-in-out fixed top-20 left-0 bottom-0 z-50
