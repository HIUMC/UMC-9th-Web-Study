...
interface CustomInternalAxioasRequestConfig extends InternalAxiosRequestConfig {
...
// 요청 인터셉터: 머든 요청 전에 accessToken을 Authorization 헤더에 추가한다.
...
axiosInstance.interceptors.response.use(
    ...
    async(error) => {
        const originalRequest: CustomInternalAxioasRequestConfig = error.config;
