...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between bg-[#323232] h-[60px]">
      <h1 className="font-bold text-[#FF1E9D] ml-5 text-xl">돌려돌려LP판</h1>
      <div className="flex items-center gap-2">
        ...
        <button className="bg-[#FF1E9D] text-white text-sm font-medium rounded-sm px-4 py-1 cursor-pointer">회원가입</button>
      </div>
    </div>
  )
}
