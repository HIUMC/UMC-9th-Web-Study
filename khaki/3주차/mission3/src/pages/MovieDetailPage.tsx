...
const MovieDetailPage = () => {
  ...
  return (
    <>
      ...
      {!isPending && (
        <div className="p-4 min-h-screen flex flex-col gap-4 bg-black">
          <div 
          className="text-white bg-cover bg-center rounded-xl p-2 flex-1 min-h-0 grid grid-cols-5"
          style={{
          ...
          <div className="bg-transparent flex-1 min-h-0 p-2">
