...
const NowPlaying = () => {
  ...
  useLoadApi('now_playing', setMovies, page, setLoading);

  return (
    <>
    <div className='flex justify-center content-center gap-4 h-[80px]'>
        <button onClick={handleMinus} className='p-4 bg-purple-300 rounded-xl h-[50px] w-[70px] text-xl font-bold hover:bg-green-200 transition-all'>&lt;</button>
